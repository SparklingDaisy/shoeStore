...
switch(cat_i){
case '2': subtitle = "Best"; break;
case '3': subtitle = "Moccasin & Loafers"; break;
case '4': subtitle = "Pumps & mule"; break;
case '5': subtitle = "Boots & Bootie"; break;
case '6': subtitle = "Sneakers"; break;
case '7': subtitle = "Sandar"; break;
default: subtitle = "F/W New";
}
%>
<%
/*paging*/
...
<section class="container">
	...
	<table>
		...
		<%
			if(userGroup!=0){
				%>
				<a href="itemList.jsp?category=<%=icategory %>&cp=<%=(userGroup-1)*pageSize+pageSize %>" id="paging">&lt;&lt;</a>
				<%
			}
			for(int i=userGroup*pageSize+1; i<=(userGroup*pageSize+pageSize); i++){
				%>
				&nbsp;&nbsp;<a href="itemList.jsp?category=<%=icategory %>&cp=<%=i %>" id="paging"><%=i %></a>&nbsp;&nbsp;
				<%
				if(i==totalPage){
					break;
				}
			...
			if(userGroup!=(totalPage/pageSize)-(totalPage%pageSize==0?1:0)){
				%>
				<a href="itemList.jsp?category=<%=icategory %>&cp=<%=(userGroup+1)*pageSize+1 %>" id="paging">&gt;&gt;</a>
				<%
			}
			%>
				</td>
		...
		<tbody>
			<%
			ArrayList<Shoe_itemDTO> arr = sdao.itemList(icategory, listSize, cp);
