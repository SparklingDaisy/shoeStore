   ...
   <form name="toBuy"> 
      <table>
         ...
         <thead>
            <tr>
               <td colspan="9">&nbsp;</td>
               <td colspan="1"><input type="button" value="전체선택 해제" onclick="offClick();" id="itemCartoffClick"></td>
            </tr>
            <tr>
               <td colspan="10">&nbsp;</td>
            </tr>
         ...
         <tfoot> 
            ...
            <tr rowspan="3">
               <td colspan="10" id="itemCartReadTxt">
                  선택한 상품 총 금액 : <input type="text" name="preSum" id="itemCartReadTxt" readonly> 원 
               </td>
            </tr>
            <tr>
               <td colspan="10">&nbsp;</td>
            ...
            <tr>
               <td colspan="10" id="itemCartReadTxt">
                  할인금액 : <input type="text" name="saleSum" id="itemCartReadTxt" readonly> 원 
               </td>
            </tr>
            <tr>
               <td colspan="10">&nbsp;</td>
            ...
            <tr>
               <td colspan="10" id="itemCartReadTxt">
                  최종 결제 금액 : <input type="text" name="postSum" id="itemCartReadTxt" readonly> 원
               </td>
            </tr>
            <tr>
               <td colspan="10">&nbsp;</td>
